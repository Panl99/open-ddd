...
public class InputArtifactIdState implements GenCodeState {

  private final GenCodeScene genCodeScene;

  @Override
  public void onEnter(String input) {
    PromptUtil.changePrompt(CommandConstants.INPUT_ARTIFACT_ID);
  }

  @Override
  public void complete(String input) {
    genCodeScene.getGenInputHolder().setArtifactId(input);
  }
}